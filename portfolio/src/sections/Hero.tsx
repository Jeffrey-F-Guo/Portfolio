        ...
        <div className="container">
          <div className="flex flex-col md:flex-row justify-center items-center gap-10">
            <div className="flex flex-col gap-6 max-w-lg">
              ...
              has the power to shape a better future—one line of code at a time. hello
              </p>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center py-10">
              <button className="inline-flex items-center border border-black/15 px-6 h-12 rounded-xl gap-1 mx-2 my-2 hover:bg-black/10">
                <span className="font-semibold">Explore my work</span>
                <DownArrow className="size-5"/>
              </button>
              <button className="inline-flex items-center bg-black text-gray-200 px-6 h-12 rounded-xl gap-1 mx-2 my-2 hover:bg-black/70">
                <span>👋</span>
